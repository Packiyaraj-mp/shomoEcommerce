...
import { clearError,clearUserUpdted } from "../../slices/UserSlice";
...
export default function UpdateUser(){
  ...
  useEffect(()=>{
     if(isUserUpdated){
       toast('UserUpdated successfully',{
         type:'success',
         position:toast.POSITION.BOTTOM_CENTER,
         onOpen:()=>dispatch(clearUserUpdted())
      })
     ...
     <form onSubmit={submitHandler} className="shadow-lg" encType='multipart/form-data' >
         ...
         <div className="form-group">
           ...
           <div className="form-group">
             ...
             <select
              disabled={user._id===authUser._id?true:false}
              className="form-control"
              id="role_field"
