...
export default function ConfirmOrder(){
     ...
     const itemsPrice=parseFloat(Number(cartItems.reduce((acc,item)=>(acc + item.price * item.quantity),0)).toFixed(2));
     const shippingPrice=itemsPrice > 200 ? 0 :25;
     const taxPrice=parseFloat(Number(0.05 * itemsPrice).toFixed(2));
